                                ...
                                <div role="tabpanel" class="tab-pane active promo" id="applyPromo">
                                    ...
                                    {else}
                                        <form method="post" action="{$WEB_ROOT}/cart.php?a=view">
                                            ...
                                            <button type="submit" name="validatepromo" class="btn btn-block btn-primary" value="{$LANG.orderpromovalidatebutton}">
                        ...
                        <div class="order-summary" id="orderSummary">
                            ...
                            <div class="summary-container">
                                ...
                                <div class="text-right">
                                    <a href="{$WEB_ROOT}/cart.php?a=checkout&e=false" class="btn btn-primary btn-lg btn-checkout{if $cartitems == 0} disabled{/if}" id="checkout">
